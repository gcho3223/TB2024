...
#include "/u/user/gcho/DRC/TB2024/TB2024/include/TBaux.h"
#include "/u/user/gcho/DRC/TB2024/TB2024/include/TBconfig.h"
#include "/u/user/gcho/DRC/TB2024/TB2024/include/TBdetector.h"
#include "/u/user/gcho/DRC/TB2024/TB2024/include/TBevt.h"
#include "/u/user/gcho/DRC/TB2024/TB2024/include/TBmid.h"
#include "/u/user/gcho/DRC/TB2024/TB2024/include/TBmonit.h"
#include "/u/user/gcho/DRC/TB2024/TB2024/include/TBobject.h"
#include "/u/user/gcho/DRC/TB2024/TB2024/include/TBplotengine.h"
#include "/u/user/gcho/DRC/TB2024/TB2024/include/TBread.h"
#include "/u/user/gcho/DRC/TB2024/TB2024/include/TButility.h"
#include "TBmid.h"
...
namespace ROOT {
   ...
   {
      return GenerateInitInstanceLocal((::TBread<TBfastmode>*)nullptr);
   }
   // Static variable to force the class initialization
   static ::ROOT::TGenericClassInfo *_R__UNIQUE_DICT_(Init) = GenerateInitInstanceLocal((const ::TBread<TBfastmode>*)nullptr); R__UseDummy(_R__UNIQUE_DICT_(Init));

   // Dictionary for non-ClassDef classes
   static TClass *TBreadlETBfastmodegR_Dictionary() {
      TClass* theClass =::ROOT::GenerateInitInstanceLocal((const ::TBread<TBfastmode>*)nullptr)->GetClass();
...
namespace ROOT {
   ...
   {
      return GenerateInitInstanceLocal((::TBread<TBwaveform>*)nullptr);
   }
   // Static variable to force the class initialization
   static ::ROOT::TGenericClassInfo *_R__UNIQUE_DICT_(Init) = GenerateInitInstanceLocal((const ::TBread<TBwaveform>*)nullptr); R__UseDummy(_R__UNIQUE_DICT_(Init));

   // Dictionary for non-ClassDef classes
   static TClass *TBreadlETBwaveformgR_Dictionary() {
      TClass* theClass =::ROOT::GenerateInitInstanceLocal((const ::TBread<TBwaveform>*)nullptr)->GetClass();
...
namespace ROOT {
   static TClass *TBmonitlETBfastmodegR_Dictionary();
   static void TBmonitlETBfastmodegR_TClassManip(TClass*);
   static void delete_TBmonitlETBfastmodegR(void *p);
   static void deleteArray_TBmonitlETBfastmodegR(void *p);
   static void destruct_TBmonitlETBfastmodegR(void *p);

   // Function generating the singleton type initializer
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::TBmonit<TBfastmode>*)
   {
      ::TBmonit<TBfastmode> *ptr = nullptr;
      static ::TVirtualIsAProxy* isa_proxy = new ::TIsAProxy(typeid(::TBmonit<TBfastmode>));
      static ::ROOT::TGenericClassInfo 
         instance("TBmonit<TBfastmode>", "TBmonit.h", 13,
                  typeid(::TBmonit<TBfastmode>), ::ROOT::Internal::DefineBehavior(ptr, ptr),
                  &TBmonitlETBfastmodegR_Dictionary, isa_proxy, 4,
                  sizeof(::TBmonit<TBfastmode>) );
      instance.SetDelete(&delete_TBmonitlETBfastmodegR);
      instance.SetDeleteArray(&deleteArray_TBmonitlETBfastmodegR);
      instance.SetDestructor(&destruct_TBmonitlETBfastmodegR);
      return &instance;
   }
   TGenericClassInfo *GenerateInitInstance(const ::TBmonit<TBfastmode>*)
   {
      return GenerateInitInstanceLocal((::TBmonit<TBfastmode>*)nullptr);
   }
   // Static variable to force the class initialization
   static ::ROOT::TGenericClassInfo *_R__UNIQUE_DICT_(Init) = GenerateInitInstanceLocal((const ::TBmonit<TBfastmode>*)nullptr); R__UseDummy(_R__UNIQUE_DICT_(Init));

   // Dictionary for non-ClassDef classes
   static TClass *TBmonitlETBfastmodegR_Dictionary() {
      TClass* theClass =::ROOT::GenerateInitInstanceLocal((const ::TBmonit<TBfastmode>*)nullptr)->GetClass();
      TBmonitlETBfastmodegR_TClassManip(theClass);
   return theClass;
   }
...
namespace ROOT {
   static TClass *TBmonitlETBwaveformgR_Dictionary();
   static void TBmonitlETBwaveformgR_TClassManip(TClass*);
   static void delete_TBmonitlETBwaveformgR(void *p);
   static void deleteArray_TBmonitlETBwaveformgR(void *p);
   static void destruct_TBmonitlETBwaveformgR(void *p);

   // Function generating the singleton type initializer
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::TBmonit<TBwaveform>*)
   {
      ::TBmonit<TBwaveform> *ptr = nullptr;
      static ::TVirtualIsAProxy* isa_proxy = new ::TIsAProxy(typeid(::TBmonit<TBwaveform>));
      static ::ROOT::TGenericClassInfo 
         instance("TBmonit<TBwaveform>", "TBmonit.h", 13,
                  typeid(::TBmonit<TBwaveform>), ::ROOT::Internal::DefineBehavior(ptr, ptr),
                  &TBmonitlETBwaveformgR_Dictionary, isa_proxy, 4,
                  sizeof(::TBmonit<TBwaveform>) );
      instance.SetDelete(&delete_TBmonitlETBwaveformgR);
      instance.SetDeleteArray(&deleteArray_TBmonitlETBwaveformgR);
      instance.SetDestructor(&destruct_TBmonitlETBwaveformgR);
      return &instance;
   }
   TGenericClassInfo *GenerateInitInstance(const ::TBmonit<TBwaveform>*)
   {
      return GenerateInitInstanceLocal((::TBmonit<TBwaveform>*)nullptr);
   }
   // Static variable to force the class initialization
   static ::ROOT::TGenericClassInfo *_R__UNIQUE_DICT_(Init) = GenerateInitInstanceLocal((const ::TBmonit<TBwaveform>*)nullptr); R__UseDummy(_R__UNIQUE_DICT_(Init));

   // Dictionary for non-ClassDef classes
   static TClass *TBmonitlETBwaveformgR_Dictionary() {
      TClass* theClass =::ROOT::GenerateInitInstanceLocal((const ::TBmonit<TBwaveform>*)nullptr)->GetClass();
      TBmonitlETBwaveformgR_TClassManip(theClass);
   return theClass;
   }
...
namespace ROOT {
   // Wrapper around operator delete
   static void delete_TBmonitlETBfastmodegR(void *p) {
      delete ((::TBmonit<TBfastmode>*)p);
   }
   static void deleteArray_TBmonitlETBfastmodegR(void *p) {
      delete [] ((::TBmonit<TBfastmode>*)p);
   }
   static void destruct_TBmonitlETBfastmodegR(void *p) {
      typedef ::TBmonit<TBfastmode> current_t;
      ((current_t*)p)->~current_t();
   }
} // end of namespace ROOT for class ::TBmonit<TBfastmode>

namespace ROOT {
   // Wrapper around operator delete
   static void delete_TBmonitlETBwaveformgR(void *p) {
      delete ((::TBmonit<TBwaveform>*)p);
   }
   static void deleteArray_TBmonitlETBwaveformgR(void *p) {
      delete [] ((::TBmonit<TBwaveform>*)p);
   }
   static void destruct_TBmonitlETBwaveformgR(void *p) {
      typedef ::TBmonit<TBwaveform> current_t;
      ((current_t*)p)->~current_t();
   }
} // end of namespace ROOT for class ::TBmonit<TBwaveform>
...
namespace ROOT {
   ...
   // Static variable to force the class initialization
   static ::ROOT::TGenericClassInfo *_R__UNIQUE_DICT_(Init) = GenerateInitInstanceLocal((const map<int,TBmid<TBwaveform> >*)nullptr); R__UseDummy(_R__UNIQUE_DICT_(Init));

   // Dictionary for non-ClassDef classes
   static TClass *maplEintcOTBmidlETBwaveformgRsPgR_Dictionary() {
      TClass* theClass =::ROOT::GenerateInitInstanceLocal((const map<int,TBmid<TBwaveform> >*)nullptr)->GetClass();
...
namespace ROOT {
   ...
   // Wrapper around operator delete
   static void delete_maplEintcOTBmidlETBwaveformgRsPgR(void *p) {
      delete ((map<int,TBmid<TBwaveform> >*)p);
   }
   static void deleteArray_maplEintcOTBmidlETBwaveformgRsPgR(void *p) {
      delete [] ((map<int,TBmid<TBwaveform> >*)p);
   }
...
namespace ROOT {
   ...
   // Static variable to force the class initialization
   static ::ROOT::TGenericClassInfo *_R__UNIQUE_DICT_(Init) = GenerateInitInstanceLocal((const map<int,TBmid<TBfastmode> >*)nullptr); R__UseDummy(_R__UNIQUE_DICT_(Init));

   // Dictionary for non-ClassDef classes
   static TClass *maplEintcOTBmidlETBfastmodegRsPgR_Dictionary() {
      TClass* theClass =::ROOT::GenerateInitInstanceLocal((const map<int,TBmid<TBfastmode> >*)nullptr)->GetClass();
...
namespace ROOT {
   ...
   // Wrapper around operator delete
   static void delete_maplEintcOTBmidlETBfastmodegRsPgR(void *p) {
      delete ((map<int,TBmid<TBfastmode> >*)p);
   }
   static void deleteArray_maplEintcOTBmidlETBfastmodegRsPgR(void *p) {
      delete [] ((map<int,TBmid<TBfastmode> >*)p);
   }
...
namespace ROOT {
   ...
   // Static variable to force the class initialization
   static ::ROOT::TGenericClassInfo *_R__UNIQUE_DICT_(Init) = GenerateInitInstanceLocal((const map<int,FileController<TBwaveform>*>*)nullptr); R__UseDummy(_R__UNIQUE_DICT_(Init));

   // Dictionary for non-ClassDef classes
   static TClass *maplEintcOFileControllerlETBwaveformgRmUgR_Dictionary() {
      TClass* theClass =::ROOT::GenerateInitInstanceLocal((const map<int,FileController<TBwaveform>*>*)nullptr)->GetClass();
...
namespace ROOT {
   ...
   // Wrapper around operator delete
   static void delete_maplEintcOFileControllerlETBwaveformgRmUgR(void *p) {
      delete ((map<int,FileController<TBwaveform>*>*)p);
   }
   static void deleteArray_maplEintcOFileControllerlETBwaveformgRmUgR(void *p) {
      delete [] ((map<int,FileController<TBwaveform>*>*)p);
   }
...
namespace ROOT {
   ...
   // Static variable to force the class initialization
   static ::ROOT::TGenericClassInfo *_R__UNIQUE_DICT_(Init) = GenerateInitInstanceLocal((const map<int,FileController<TBfastmode>*>*)nullptr); R__UseDummy(_R__UNIQUE_DICT_(Init));

   // Dictionary for non-ClassDef classes
   static TClass *maplEintcOFileControllerlETBfastmodegRmUgR_Dictionary() {
      TClass* theClass =::ROOT::GenerateInitInstanceLocal((const map<int,FileController<TBfastmode>*>*)nullptr)->GetClass();
...
namespace ROOT {
   ...
   // Wrapper around operator delete
   static void delete_maplEintcOFileControllerlETBfastmodegRmUgR(void *p) {
      delete ((map<int,FileController<TBfastmode>*>*)p);
   }
   static void deleteArray_maplEintcOFileControllerlETBfastmodegRmUgR(void *p) {
      delete [] ((map<int,FileController<TBfastmode>*>*)p);
   }
...
"/u/user/gcho/DRC/TB2024/TB2024/include",
"/cvmfs/sft.cern.ch/lcg/releases/yamlcpp/0.6.3-d05b2/x86_64-centos7-gcc11-opt/include",
"/cvmfs/sft.cern.ch/lcg/views/LCG_102/x86_64-centos7-gcc11-opt/include",
"/u/user/gcho/DRC/TB2024/TB2024",
"/cvmfs/sft.cern.ch/lcg/releases/ROOT/6.26.04-edd28/x86_64-centos7-gcc11-opt/include/",
"/u/user/gcho/DRC/TB2024/TB2024/build/",
nullptr
    };
...
class __attribute__((annotate("$clingAutoload$TBdetector.h")))  __attribute__((annotate("$clingAutoload$/u/user/gcho/DRC/TB2024/TB2024/include/TBaux.h")))  TBcid;
template <class T> class __attribute__((annotate("$clingAutoload$TBevt.h")))  __attribute__((annotate("$clingAutoload$/u/user/gcho/DRC/TB2024/TB2024/include/TBaux.h")))  TBevt;

template <class T> class __attribute__((annotate("$clingAutoload$TBread.h")))  __attribute__((annotate("$clingAutoload$/u/user/gcho/DRC/TB2024/TB2024/include/TBmonit.h")))  TBread;

template <class T> class __attribute__((annotate("$clingAutoload$/u/user/gcho/DRC/TB2024/TB2024/include/TBmonit.h")))  TBmonit;
...
"TBmonit<TBfastmode>", payloadCode, "@",
"TBmonit<TBwaveform>", payloadCode, "@",
